...
if [ $choice -eq 1 ] ; then
	...
	wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCU_installer_latest.sh && bash "$root/TCU_installer_latest.sh"
	...
	bash "$root/linuxAIO.sh"
		...
		if [ $choice -eq 2 ] ; then
			...
			wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCU_run.sh && bash "$root/TCU_run.sh"
			...
			if [ $choice -eq 3 ] ; then
				...
				wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCUAutoRestartAndUpdate.sh && bash "$root/TCUAutoRestartAndUpdate.sh"
				...
				if [ $choice -eq 4 ] ; then
					...
					wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCUautoinstaller.sh && bash "$root/TCUautoinstaller.sh"
...
bash "$root/linuxAIO.sh"
						...
						wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCUpm2setup.sh && bash "$root/TCUpm2setup.sh"
						...
						bash "$root/linuxAIO.sh"
							...
							wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCUpm2start.sh && bash "$root/TCUpm2start.sh"
