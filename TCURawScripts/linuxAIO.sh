...
# If you wish to edit this file, make sure to read the TCUGuide folder in the gitlab.
...
# Like you can see below, the link "https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCU_master_installer.sh" is a GitLab-raw link
...
wget -N https://gitlab.com/Dok4440/TCUBetaBot/-/raw/develop/TCURawScripts/TCU_master_installer.sh
